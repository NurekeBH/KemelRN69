...
import { View, Dimensions, Platform, StatusBar, StyleSheet } from 'react-native';

const STATUSBAR_DEFAULT_HEIGHT = 20;
const STATUSBAR_X_HEIGHT = 44;
const STATUSBAR_IP12_HEIGHT = 47;
const STATUSBAR_IP12MAX_HEIGHT = 47;
const STATUSBAR_IP14 = 59;
...
if (Platform.OS === 'ios' && !Platform.isPad && !Platform.isTVOS) {
    if (W_WIDTH === X_WIDTH && W_HEIGHT === X_HEIGHT) {
        ...
        isIPhoneWithMonobrow_v = true;
        statusBarHeight = STATUSBAR_IP14;
...
export const StatusBarHeightPlatform = Platform.select({
    ios: statusBarHeight,
...
const styles = StyleSheet.create({
    statusBar: {
        height: StatusBarHeightPlatform,
    },
});
